...
import com.gary.commercial.bean.DeviceInfo;
...
public class DeviceInfoUtil {
    ...
    public static String getMacAddress() {
        ...
        try {
            ...
            CLog.e(TAG, "getMacAddress exception: " + e.getMessage());
        }
    ...
    private static InetAddress getLocalInetAddress() {
        ...
        try {
            ...
            CLog.e(TAG, "getLocalInetAddress exception: " + e.getMessage());
        }
        return ip;
    }
    ...
    public static int getTotalRAM(){
        ...
        try{
            ...
            CLog.e(TAG, "Catch Exception: " + e.getMessage());
        }
        if(firstLine != null){
            try {
                totalRam = (int)Math.ceil((Float.valueOf(Float.valueOf(firstLine) / (1024 * 1024)).doubleValue()));
            } catch (Exception e) {
                CLog.e(TAG, "getTotalRam exception: " + e.getMessage());
            }
        }
        return totalRam;
    }
